...
$address = "asesoria@grouplegaltic.com";
...
$e_subject = 'Solicitud de Asesoría ';
...
$e_body = "Ha sido contactado por $name, el mensaje que ha dejado es el siguiente:." . PHP_EOL . PHP_EOL;
$e_content = "\"$comments\"" . PHP_EOL . PHP_EOL;
$e_reply = "Por favor contáctame $name via email, $email o al siguiente número $phone";
...
header('Location: ../../index.php?send=ok');
	...
	echo "<h3>Email enviado correctamente.</h3>";
	echo "<p>Gracias <strong>$name</strong>, su mensaje ha sido enviado con éxito.</p>";
	echo "</div>";
